...
map.getView().fit([189994.922870, 5596555.044454, 202461.385667, 5603269.816991], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Parcelles privees Reedition VTT</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_parcellesprivees_reedition_1,
    colName: 'idu',
    zoom: 10,
    collapsed: true,
    map: map
